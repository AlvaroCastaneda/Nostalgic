...
--
-- Host: localhost    Database: nostalgic
-- ------------------------------------------------------
...
CREATE TABLE `lista_contacto` (
  ...
  CONSTRAINT `fk_Usuario_Lista` FOREIGN KEY (`idlista_Contacto`) REFERENCES `usuario` (`idusuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `reply` (
  ...
  CONSTRAINT `fk_Reply_Conversacion` FOREIGN KEY (`idreply`) REFERENCES `conversacion` (`idconversacion`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-11-15 19:19:24
